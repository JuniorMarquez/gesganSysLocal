    ...
    $scope.getOrdenos = function () {
      ...
      $http.get('http://localhost:1337/ordeno/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
        ...
        for (var i  = 0; i<$scope.ordenos2.length;i++){
          ...
          if(!$scope.ordenos2[i].observaciones){$scope.ordenos2[i].observaciones="-"};
        }
...
$scope.getPesos = function () {
      $scope.pesos=null;
      $http.get('http://localhost:1337/peso/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
    ...
    $scope.getMedicamentos();
     $scope.getAlimentos = function () {
      ...
      $http.get('http://localhost:1337/sumalimento/?idAnimal='+MyService.data.animalConsultado.id).then(function (resp) {
