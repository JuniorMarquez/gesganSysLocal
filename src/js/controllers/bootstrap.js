...
$http.get('http://localhost:1337/raza/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
$http.get('http://localhost:1337/tipoBano/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
$http.get('http://localhost:1337/medicamento/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
$http.get('http://localhost:1337/bano/?idUsuario='+MyService.data.idUsuario).then(function (resp2) {
    var bandera="";
    var bandera2="";
...
$scope.borrarMedicamento=function(item){
   var idMedicamento=item.id;
      $http.delete('http://localhost:1337/medicamento/'+idMedicamento , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarBano=function(item){
   var idBano=item.id;
      $http.delete('http://localhost:1337/bano/'+idBano , item)
      $modalInstance.dismiss('cancel');
};
$scope.borrarTipoBano=function(item){
   var idTipoBano=item.id;
      $http.delete('http://localhost:1337/tipoBano/'+idTipoBano , item)
      $modalInstance.dismiss('cancel');
};
 ...
 //    };
     ...
     $scope.nuevoAnimal.idArete=item.idArete;
      $scope.nuevoAnimal.nombre=item.nombre;
       ...
       $http.post('http://localhost:1337/animal/' ,$scope.nuevoAnimal);
      $modalInstance.close();
      // var pas = item._id;
      // $scope.ordenosFiltrados = $scope.ordenos.filter(function (ordeno) {
      //   return (ordeno.idAnimal == pas );
    ...
    // });
     ...
     $scope.okTipoMedicamento = function (item) {
      ...
      $modalInstance.close();
       ...
       item.idUsuario=MyService.data.idUsuario;
      $http.post('http://localhost:1337/tipobano/' ,item);       
      $modalInstance.close();
      };
...
// ##########################################################################
    ...
    $http.delete('http://localhost:1337/grupo/'+idGrupo, item)
